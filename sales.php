                  ...
                  <?php 
                   ...
                   while($row = mysqli_fetch_assoc($result)){
                    $sno = $row['sno'];
                      ...
                      ?>
                      <tr>
                      <td style="text-align:center;"><a href="details.php?id=<?php echo $sno;?>"><?php echo $sno?></a></td>
                        <td><?php echo $date;?></td>
                        <td><?php echo $name;?></td>
                        <td><?php echo $product;?></td>
                        <td><?php echo $method;?></td>
                        <td><?php if($status==''){echo "Pending";}else{echo "Delivered";}?>
                        </td>
                        <td><a style = "background:red;padding:8px;color:white;" href = "delete.php?sno=<?php echo $sno?>">Delete</a></td>
                      </tr>
                      <?php
                   }
                  ?>
